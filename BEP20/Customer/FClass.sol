...
contract FClass is BEP20, Pausable, BEP20Detailed {
	...
	constructor() public BEP20Detailed("FClass Vietnam", "FC", 6) {  
	        
       
        totalCoins = 69000000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 69 billion coins
    }
